      ...
      <div class="content">
        <div class="container-fluid">
          <div class="header text-center">
            <h3 class="title">JADWAL KULIAH UMUM & PKKMB IKMI 2019</h3>
            <p class="category">Jadwal dan Tata Tertib Dapat Dilihat di
              <a target="_blank" href="http://bemstmikikmi.rf.gd/">bemstmikikmi.rf.gd</a>. 
